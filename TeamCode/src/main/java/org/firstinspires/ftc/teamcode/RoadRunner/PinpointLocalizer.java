...
public final class PinpointLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = -2668.5722806578465; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -2614.8370305722183; // x position of the perpendicular encoder (in tick units)
    }
